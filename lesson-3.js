...
// const dataValues = data.flatMap(el => el.values);
...
//   }
//  }
//  const client = new Client("denis", "denis@example.com");

// console.log(client.login); // 👉 "denis"
// console.log(client.email); // 👉 "denis@example.com"
...
// Завдання 13:
  ...
  // Крім того, клас `Employee` має мати метод `getEmployeeDetails()`, який повертає об'єкт з зарплати.
